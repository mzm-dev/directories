    ...
    <div class="span12">
        <div class="widget">
            <div class="widget-header">
                ...
                <div class="tools">
                    <div class="btn-group">
                        <?php echo $this->Html->link(('Edit Position'), array('action' => 'edit', $position['Position']['id']), array('class' => 'btn btn-info', 'data-placement' => 'top', 'data-original-title' => 'Edit Position', 'escape' => FALSE)); ?>
                    </div>
                </div>
            </div>
